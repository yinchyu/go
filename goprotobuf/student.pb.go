...
type StudentList struct {
	...
	TargetList []*StudentList_Student `protobuf:"bytes,1,rep,name=TargetList,proto3" json:"TargetList,omitempty"`
}
...
func (x *StudentList) GetTargetList() []*StudentList_Student {
	if x != nil {
		return x.TargetList
	}
	return nil
...
type StudentList_Student struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StudentList_Student) Reset() {
	*x = StudentList_Student{}
	if protoimpl.UnsafeEnabled {
...
func (x *StudentList_Student) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StudentList_Student) ProtoMessage() {}

func (x *StudentList_Student) ProtoReflect() protoreflect.Message {
	mi := &file_student_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StudentList_Student.ProtoReflect.Descriptor instead.
func (*StudentList_Student) Descriptor() ([]byte, []int) {
	return file_student_proto_rawDescGZIP(), []int{0, 0}
}

func (x *StudentList_Student) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *StudentList_Student) GetMale() bool {
	if x != nil {
		return x.Male
	}
	return false
...
func (x *StudentList_Student) GetScores() []int32 {
	if x != nil {
		return x.Scores
	}
	return nil
...
var file_student_proto_rawDesc = []byte{
	...
	0x04, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0x93, 0x01, 0x0a, 0x0b, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e,
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x39, 0x0a, 0x0a, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x4c,
	0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d, 0x61, 0x69, 0x6e,
	0x2e, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x2e, 0x53, 0x74, 0x75,
	0x64, 0x65, 0x6e, 0x74, 0x52, 0x0a, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74,
	0x1a, 0x49, 0x0a, 0x07, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	...
	0x03, 0x28, 0x05, 0x52, 0x06, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_student_proto_goTypes = []interface{}{
	(*StudentList)(nil),         // 0: main.StudentList
	(*StudentList_Student)(nil), // 1: main.StudentList.Student
}
var file_student_proto_depIdxs = []int32{
	1, // 0: main.StudentList.TargetList:type_name -> main.StudentList.Student
...
func file_student_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_student_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StudentList_Student); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
