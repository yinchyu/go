...
// 	fmt.Println("sct",sct.Kind())
// 	fmt.Println("sct",sct.String())
// 	fmt.Println("sct",sct.NumMethod())
// 	// 	func packagetest(s sc) (){
// 	//
// 	// 	}
// 	// }
// }
...
// 	s:=student{}
// 	rt:=reflect.TypeOf(s)
// 	fieldname1 ,_ :=rt.FieldByName("name")
// 	fieldname2 ,_ :=rt.FieldByName("age")
// 	fmt.Println(fieldname1.Tag)
// 	fmt.Println(fieldname2.Tag)
...
// 	// log.Printf("%v","helloworrld")
// 	//  根据不同的类型进行反射， kind 是slice   sct string [] int
// }
// redis_test project a.go
package main
...
func standalon_redis_test() {
	...
	// publish a message
	err = client.Publish("test_channel", "packagetest").Err()
	if err != nil {
